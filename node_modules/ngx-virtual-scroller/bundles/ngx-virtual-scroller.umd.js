    ...
    ***************************************************************************** */
    ...
    var VirtualScrollerComponent = /** @class */ (function () {
        ...
        VirtualScrollerComponent = __decorate([
            ...
            __param(5, core.Optional()), __param(5, core.Inject('virtualScroller.scrollThrottlingTime')),
            __param(6, core.Optional()), __param(6, core.Inject('virtualScroller.scrollDebounceTime')),
            __param(7, core.Optional()), __param(7, core.Inject('virtualScroller.scrollAnimationTime')),
            __param(8, core.Optional()), __param(8, core.Inject('virtualScroller.scrollbarWidth')),
            __param(9, core.Optional()), __param(9, core.Inject('virtualScroller.scrollbarHeight')),
            __param(10, core.Optional()), __param(10, core.Inject('virtualScroller.checkResizeInterval')),
            __param(11, core.Optional()), __param(11, core.Inject('virtualScroller.resizeBypassRefreshThreshold')),
            __param(12, core.Optional()), __param(12, core.Inject('virtualScroller.modifyOverflowStyleOfParentScroll')),
            __param(13, core.Optional()), __param(13, core.Inject('virtualScroller.stripedTable')),
