...
var VirtualScrollerComponent = /** @class */ (function () {
    ...
    VirtualScrollerComponent = __decorate([
        ...
        __param(5, Optional()), __param(5, Inject('virtualScroller.scrollThrottlingTime')),
        __param(6, Optional()), __param(6, Inject('virtualScroller.scrollDebounceTime')),
        __param(7, Optional()), __param(7, Inject('virtualScroller.scrollAnimationTime')),
        __param(8, Optional()), __param(8, Inject('virtualScroller.scrollbarWidth')),
        __param(9, Optional()), __param(9, Inject('virtualScroller.scrollbarHeight')),
        __param(10, Optional()), __param(10, Inject('virtualScroller.checkResizeInterval')),
        __param(11, Optional()), __param(11, Inject('virtualScroller.resizeBypassRefreshThreshold')),
        __param(12, Optional()), __param(12, Inject('virtualScroller.modifyOverflowStyleOfParentScroll')),
        __param(13, Optional()), __param(13, Inject('virtualScroller.stripedTable')),
...
export { VirtualScrollerComponent, VirtualScrollerModule };
